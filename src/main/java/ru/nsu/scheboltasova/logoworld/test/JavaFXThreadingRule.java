...
public class JavaFXThreadingRule implements TestRule {
    static Command commandDraw;
    static Command commandWard;
    static Command commandTeleport;
    static Command commandInit;
    static Command commandMove;
    static FieldParameters param;
